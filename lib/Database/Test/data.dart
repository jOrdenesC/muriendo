...
ExcerciseData gifdata = ExcerciseData(
    id: 1,
    videoName: 'C1',
    mets: 12,
    nameExcercise: 'SKIPPING',
    recommendation: 'NO Explotes');
ExcerciseData gifdata2 = ExcerciseData(
    id: 2,
    videoName: 'C2',
    mets: 12,
    nameExcercise: 'JUMPING JACKS',
    recommendation: 'NO Explotes');
ExcerciseData gifdata3 = ExcerciseData(
    id: 3,
    videoName: 'C3',
    mets: 12,
    nameExcercise: 'Sentadilla',
    recommendation: 'NO Explotes');
ExcerciseData gifdata4 = ExcerciseData(
    id: 4,
    videoName: 'C4',
    mets: 12,
    nameExcercise: 'ESCALADOR',
    recommendation:
...
ExcerciseData gifdata5 = ExcerciseData(
    id: 5,
    videoName: 'C5',
    mets: 12,
    nameExcercise: 'ATRAPA MOSCAS',
    recommendation:
...
ExcerciseData gifdata6 = ExcerciseData(
    id: 6,
    videoName: 'C6',
    mets: 12,
    nameExcercise: 'JUMPING JACKS',
...
ExcerciseData gifdata7 = ExcerciseData(
    id: 7,
    videoName: 'C7',
    mets: 12,
    nameExcercise: 'LOW RUNNER',
    recommendation:
        'Mantén la espalda erguida. Flecta un poco las rodillas. No te inclines hacia adelante. Contrae el abdomen.');
ExcerciseData gifdata8 = ExcerciseData(
    id: 8,
    videoName: 'C8',
    mets: 12,
    nameExcercise: 'SENTADILLAS',
    recommendation:
...
ExcerciseData gifdata9 = ExcerciseData(
    id: 9,
    videoName: 'C9',
    mets: 12,
    nameExcercise: 'SKIPPING',
...
ExcerciseData gifdata10 = ExcerciseData(
    id: 10,
    videoName: 'C10',
    mets: 12,
    nameExcercise: 'GUERRERO 3',
    recommendation:
        'Mantén la columna recta y estirada. No gires la pelvis. Aprieta los glúteos.');
ExcerciseData gifdata11 = ExcerciseData(
    id: 11,
    videoName: 'C11',
    mets: 12,
    nameExcercise: 'ESTIRAMIENTO MARIPOSA',
    recommendation:
...
ExcerciseData gifdata12 = ExcerciseData(
    id: 12,
    videoName: 'C12',
    mets: 12,
    nameExcercise: 'FILA DE AIRE',
    recommendation:
        'Mantén la espalda erguida. Contrae el abdomen y los glúteos. No encojas los hombros. Junta las escapulas.');
ExcerciseData gifdata13 = ExcerciseData(
    id: 13,
    videoName: 'C13',
    mets: 12,
    nameExcercise: 'PINZA DE PIE 1',
    recommendation:
